...
# Programming Languages Management on Manjaro Linux
...
* **Installation**: Configures the global Node.js LTS 22 release:
  ...
  ```
* **Safe NPM Updates**: Cleans npm cache and pre-installs the `promise-retry` package to bypass common npm registry upgrade errors on Manjaro, then updates NPM:
  ```bash
