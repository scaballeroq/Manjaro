...
# Aplicaciones y Juegos en Manjaro Linux
...
El ecosistema de Manjaro Linux (Trixie) permite instalar tanto herramientas visuales del sistema mediante gestores de paquetes tradicionales (APT) como software de ocio de forma aislada a través de formatos universales (Flatpak).
