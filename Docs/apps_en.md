...
# Applications and Games on Manjaro Linux
...
The Manjaro Linux (Trixie) ecosystem allows installing system utilities through traditional package managers (APT) and application environments like gaming platforms in sandbox environments using universal formats (Flatpak).
