# =============================================================================
# FUNCIONES PARA PODMAN (podman-functions.zsh) - Manjaro Linux (ZSH)
# =============================================================================
...
# Limpieza total del sistema (imágenes, contenedores parados, redes y volúmenes)
pclean-total() {
...
prm-stopped() {
    ...
    stopped_containers=$(podman ps -aq -f status=exited 2>/dev/null || true)
...
echo "✅ Funciones de Podman para ZSH cargadas"
